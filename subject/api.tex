...
\noindent \begin{tabular}{lp{15cm}}
\textbf{Constante:} & OR\_INITIAL \\
\textbf{Valeur:} & 20 \\
\textbf{Description:} & Or initialement possédé par chaque joueur \\
\end{tabular} 
\vspace{0.2cm} \\
...
\noindent \begin{tabular}{lp{15cm}}
\textbf{Constante:} & LIMITE\_BATEAUX \\
\textbf{Valeur:} & 500 \\
\textbf{Description:} & Limite du nombre de bateaux pour chaque joueur \\
\end{tabular} 
\vspace{0.2cm} \\
...
\begin{tabular}[t]{@{\extracolsep{0pt}}lp{7cm}}
        ...
        \textsl{BATEAU\_ENNEMI}~: & Le bateau ne vous appartient pas \\
        ...
        \textsl{LIMITE\_ATTEINTE}~: & La limite de bateaux est atteinte \\
...
\noindent
\begin{tabular}[t]{@{\extracolsep{0pt}}>{\bfseries}lp{10cm}}
Description~: & Retourne vrai si le bateau ayant pour identifiant ``id`` existe et est encore à flot \\
...
\begin{minipage}{\linewidth}
\functitle{id\_dernier\_bateau\_construit}
...
\noindent
\begin{tabular}[t]{@{\extracolsep{0pt}}>{\bfseries}lp{10cm}}
Description~: & Retourne l'ID du dernier bateau construit. Son comportement n'est pas défini si vous n'avez pas encore créé de bateau à ce tour-ci. \\
...
\noindent
\begin{tabular}[t]{@{\extracolsep{0pt}}>{\bfseries}lp{10cm}}
Description~: & Transfère ``montant`` or de la caravelle ``id\_source`` à la caravelle ``id\_dest`` \\
...
\begin{tabular}[t]{@{\extracolsep{0pt}}ll}
        ...
        \textsl{montant}~: & Montant d'or à transférer \\
      
    
      
        \textsl{id\_source}~: & Caravelle d'origine \\
      
    
      
        \textsl{id\_dest}~: & Caravelle de destination \\
...
\noindent
\begin{tabular}[t]{@{\extracolsep{0pt}}>{\bfseries}lp{10cm}}
Description~: & Retourne le nombre de bateaux que possède le joueur désigné par l'identifiant ``id`` \\
